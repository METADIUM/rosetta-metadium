...
import (
	...
	mocks "github.com/metadium/rosetta-metadium/mocks/services"
...
func TestConstructionService(t *testing.T) {
	...
	// Test Preprocess
	intent := `[{"operation_identifier":{"index":0},"type":"CALL","account":{"address":"0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C"},"amount":{"value":"-42894881044106498","currency":{"symbol":"META","decimals":18}}},{"operation_identifier":{"index":1},"type":"CALL","account":{"address":"0x57B414a0332B5CaB885a451c2a28a07d1e9b8a8d"},"amount":{"value":"42894881044106498","currency":{"symbol":"META","decimals":18}}}]` // nolint
	...
	assert.Nil(t, err)
	optionsRaw := `{"from":"0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C"}`
	var options options
	...
	mockClient.On(
		"PendingNonceAt",
		ctx,
		common.HexToAddress("0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C"),
	).Return(
		uint64(0),
		nil,
	).Once()
		...
		SuggestedFee: []*types.Amount{
			{
				...
				Currency: metadium.Currency,
			},
		},
	}, metadataResponse)

	// Test Payloads  80000000000
	unsignedRaw := `{"from":"0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C","to":"0x57B414a0332B5CaB885a451c2a28a07d1e9b8a8d","value":"0x9864aac3510d02","data":"0x","nonce":"0x0","gas_price":"0x12a05f2000","gas":"0x5208","chain_id":"0xc"}` // nolint
	...
	assert.Nil(t, err)
	payloadsRaw := `[{"address":"0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C","hex_bytes":"081f83432348c7b63c4b2c328b2e120a815a4b8bdbe75845ac069ee04b0e3b43","account_identifier":{"address":"0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C"},"signature_type":"ecdsa_recovery"}]` // nolint
	...
	// Test Parse Unsigned
	parseOpsRaw := `[{"operation_identifier":{"index":0},"type":"CALL","account":{"address":"0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C"},"amount":{"value":"-42894881044106498","currency":{"symbol":"META","decimals":18}}},{"operation_identifier":{"index":1},"related_operations":[{"index":0}],"type":"CALL","account":{"address":"0x57B414a0332B5CaB885a451c2a28a07d1e9b8a8d"},"amount":{"value":"42894881044106498","currency":{"symbol":"META","decimals":18}}}]` // nolint
	...
	signaturesRaw := `[{"hex_bytes":"5f22dc4b318c51f636beb17e0483ca8f36d7a43d8acdff63eaed921bff5dc2c20f51930067cb001dbb1ba675e652cbf93375b4646b31d0818aa94917f3e6fda600","signing_payload":{"address":"0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C","hex_bytes":"081f83432348c7b63c4b2c328b2e120a815a4b8bdbe75845ac069ee04b0e3b43","account_identifier":{"address":"0xbe862AD9AbFe6f22BCb087716c7D89a26051f74C"},"signature_type":"ecdsa_recovery"},"public_key":{"hex_bytes":"036d9038945ff8f4669201ba1e806c9a46a5034a578e4d52c03152198538039294","curve_type":"secp256k1"},"signature_type":"ecdsa_recovery"}]` // nolint
	...
	signedRaw := `{"type":"0x0","nonce":"0x0","gasPrice":"0x12a05f2000","maxPriorityFeePerGas":null,"maxFeePerGas":null,"gas":"0x5208","value":"0x9864aac3510d02","input":"0x","v":"0x3b","r":"0x5f22dc4b318c51f636beb17e0483ca8f36d7a43d8acdff63eaed921bff5dc2c2","s":"0xf51930067cb001dbb1ba675e652cbf93375b4646b31d0818aa94917f3e6fda6","to":"0x57b414a0332b5cab885a451c2a28a07d1e9b8a8d","hash":"0xab19fc6e16b096133d976cc7ee75f09514e8ab9eedf77b86c1744cf48de0cb90"}` // nolint
	...
	transactionIdentifier := &types.TransactionIdentifier{
		...
		Hash: "0xab19fc6e16b096133d976cc7ee75f09514e8ab9eedf77b86c1744cf48de0cb90",
	}
